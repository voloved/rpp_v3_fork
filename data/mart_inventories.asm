...
; Viridian
ViridianCashierText::
	TX_MART POKE_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, REPEL

; Pewter
PewterCashierText::
	TX_MART POKE_BALL, POTION, ESCAPE_ROPE, SUPER_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL

; Cerulean
CeruleanCashierText::
	TX_MART POKE_BALL, POTION, SUPER_REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL
...
VermilionCashierText::
	TX_MART POKE_BALL, SUPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL, SUPER_REPEL
...
CeladonMart4ClerkText::
	TX_MART CLEANSE_TAG, POKE_DOLL, CLEANSE_TAG, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE
...
; Fuchsia
FuchsiaCashierText::
	TX_MART ULTRA_BALL, GREAT_BALL, THIEF_BALL, SUPER_POTION, REVIVE, FULL_HEAL, SUPER_REPEL
