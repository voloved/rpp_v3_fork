...
BlackbeltData:
	...
	db "Lao@",31,MANKEY,PRIMEAPE,ANNIHILAPE,$FF
	db "Hung@",32,MACHOKE,MACHAMP,$FF
...
ProfOakData:
	...
	db 70,NIDOKING
	moveset EARTHQUAKE, THUNDERBOLT, BLIZZARD, ROCK_SLIDE
	db $FF
	...
	db 69,VENUSAUR
	moveset RAZOR_LEAF, BODY_SLAM, SLEEP_POWDER, TOXIC
	...
	db 69,CHARIZARD
	moveset FIRE_SPIN, FIRE_BLAST, EARTHQUAKE, SLASH
