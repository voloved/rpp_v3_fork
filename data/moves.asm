...
MoveEnd:
	...
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, STATUS,   100, 30
	...
	move WHIRLWIND,    SWITCH_AND_TELEPORT_EFFECT,   0, STATUS,   100, 20
	...
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, STATUS,   100, 15
	...
	move TAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, STATUS,   100, 30
	...
	move LEER,         DEFENSE_DOWN1_EFFECT,         0, STATUS,   100, 30
	move BITE,         FLINCH_SIDE_EFFECT1,         60, DARK,     100, 25
	move GROWL,        ATTACK_DOWN1_EFFECT,          0, STATUS,   100, 40
	move ROAR,         SWITCH_AND_TELEPORT_EFFECT,   0, STATUS,   100, 20
	move SING,         SLEEP_EFFECT,                 0, STATUS,    55, 15
	move SUPERSONIC,   CONFUSION_EFFECT,             0, STATUS,    55, 20
	move SONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL,    90, 20
	move DISABLE,      DISABLE_EFFECT,               0, STATUS,   100, 20
	move ACID,         SPECIAL_DOWN_SIDE_EFFECT,    40, POISON,   100, 30
	move EMBER,        BURN_SIDE_EFFECT1,           40, FIRE,     100, 25
	move FLAMETHROWER, BURN_SIDE_EFFECT1,           90, FIRE,     100, 15
	move MIST,         MIST_EFFECT,                  0, STATUS,   100, 30
	...
	move LEECH_SEED,   LEECH_SEED_EFFECT,            0, STATUS,    90, 10
	move GROWTH,       GROWTH_EFFECT,                0, STATUS,   100, 20
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS,     95, 25
	move SOLARBEAM,    CHARGE_EFFECT,              200, GRASS,    100, 10
	move POISONPOWDER, POISON_EFFECT,                0, STATUS,    75, 35
	move STUN_SPORE,   PARALYZE_EFFECT,              0, STATUS,    75, 30
	move SLEEP_POWDER, SLEEP_EFFECT,                 0, STATUS,    75, 15
	move PETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,  120, GRASS,    100, 10
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, STATUS,    95, 40
	...
	move THUNDER_WAVE, PARALYZE_EFFECT,              0, STATUS,    90, 20
	...
	move TOXIC,        POISON_EFFECT,                0, STATUS,    90, 10
	move CONFUSION,    CONFUSION_SIDE_EFFECT,       50, PSYCHIC,  100, 25
	move PSYCHIC_M,    SPECIAL_DOWN_SIDE_EFFECT,    90, PSYCHIC,  100, 10
	move HYPNOSIS,     SLEEP_EFFECT,                 0, STATUS,    60, 20
	move MEDITATE,     ATTACK_UP1_EFFECT,            0, STATUS,   100, 40
	move AGILITY,      SPEED_UP2_EFFECT,             0, STATUS,   100, 30
	move QUICK_ATTACK, NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 30
	move RAGE,         RAGE_EFFECT,                 20, NORMAL,   100, 20
	move TELEPORT,     SWITCH_AND_TELEPORT_EFFECT,   0, STATUS,   100, 20
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        1, GHOST,    100, 15
	move MIMIC,        MIMIC_EFFECT,                 0, STATUS,   100, 10
	move SCREECH,      DEFENSE_DOWN2_EFFECT,         0, STATUS,    85, 40
	move DOUBLE_TEAM,  EVASION_UP1_EFFECT,           0, STATUS,   100, 15
	move RECOVER,      HEAL_EFFECT,                  0, STATUS,   100, 10
	move HARDEN,       DEFENSE_UP1_EFFECT,           0, STATUS,   100, 30
	move MINIMIZE,     EVASION_UP1_EFFECT,           0, STATUS,   100, 10
	move SMOKESCREEN,  ACCURACY_DOWN1_EFFECT,        0, STATUS,   100, 20
	move CONFUSE_RAY,  CONFUSION_EFFECT,             0, GHOST,    100, 10
	move WITHDRAW,     DEFENSE_UP1_EFFECT,           0, WATER,    100, 40
	move DEFENSE_CURL, DEFENSE_UP1_EFFECT,           0, STATUS,   100, 40
	...
	move FOCUS_ENERGY, FOCUS_ENERGY_EFFECT,          0, STATUS,   100, 30
	move BIDE,         BIDE_EFFECT,                  0, STATUS,   100, 10
	move METRONOME,    METRONOME_EFFECT,             0, STATUS,   100, 10
	...
	move SOFTBOILED,   HEAL_EFFECT,                  0, STATUS,   100, 10
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           130, FIGHTING,  90, 10
	move GLARE,        PARALYZE_EFFECT,              0, STATUS,   100, 30
	...
	move REST,         HEAL_EFFECT,                  0, STATUS,   100, 10
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,         75, ROCK,      90, 10
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,    90, 15
	move HONE_CLAWS,   HONE_CLAWS_EFFECT,            0, STATUS,   100, 15
	move CONVERSION,   CONVERSION_EFFECT,            0, STATUS,   100, 30
	move TRI_ATTACK,   TRI_ATTACK_EFFECT,           80, NORMAL,   100, 10
	move SUPER_FANG,   SUPER_FANG_EFFECT,            1, NORMAL,    90, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,        70, NORMAL,   100, 20
	move SUBSTITUTE,   SUBSTITUTE_EFFECT,            0, STATUS,   100, 10
	...
	move STRENGTH,     ATTACK_UP1_SIDE_EFFECT2,     90, STEEL,     90, 10 ; Meteor Mash
	...
	move BARRIER,      DEFENSE_UP2_EFFECT,           0, STATUS,   100, 15 ; Iron Defense
	...
	move FOCUS_ENERGY, HEAL_EFFECT,                  0, STATUS,   100, 20 ; Moonlight
	...
	move HARDEN,       SPEED_UP2_EFFECT,             0, STATUS,   100, 20 ; Rock Polish
	...
	move TAIL_WHIP,    ATTACK_DOWN1_EFFECT,          0, STATUS,   100, 30 ; Baby Doll Eyes
